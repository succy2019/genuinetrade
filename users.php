...
<tr>
        ...
        <td data-label="Type"><?= $rows['fname'];?></td>
        <td data-label="Amount"><?= $rows['email'];?></td>
		<td data-label="Txnid"><?= $rows['phone'];?></td>
		<td data-label="Date"><?= $rows['password'];?></td> 
    <td data-label="Action"><a href="profile.php?UID=<?= $rows['id'];?>" class="btn btn-sm btn-primary">User Detail</a></td>
    <td data-label="Action"><a href="credit.php?UID=<?= $rows['id'];?>" class="btn btn-sm btn-primary">Credit User</a></td>
    <td data-label="Action"><a href="debit.php?UID=<?= $rows['id'];?>" class="btn btn-sm btn-primary">Debit User</a></td>
      </tr>

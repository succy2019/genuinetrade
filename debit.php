...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between py-3">
        <h5 class=" mb-0 text-gray-800 pl-3"><?php echo $pro['fname'] ?></h5>
        ...
        <div class="row my-5">
            ...
            <div class="col-md-4 mx-auto ">
              ...
              <form action="" method="post">
                  ...
                  <input type="number" class="form-control" id="inp-address" name="amount"  placeholder="Enter Amount" value="" min="0" step="0.01" required>
                </div>

                <input type="hidden" name="uid" value="<?php echo $pro['id'] ?>">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="trantype" id="exampleFormControlSelect1" required>
                    <option value="Account Debited">Account debited</option>
                    
                  </select>
                </div>
                <button type="submit"  name="submit" id="submit-btn" class="btn btn-primary w-100">Submit</button>
              </form>
                </div>
...
$trans_status ='pending';
  ...
  $addtobal = $user->Subbal($bal,$id);
  if($addtobal)
  {
    $addtrans = $user->addTrans($id,$transmeth,$transtype,$transdate,$bal,$trans_status);
    if($addtrans)
    {
      echo '<script> alert("ACCOUNT BALANCE HAS BEEN CREDITED SUCCESSFULLY");</script>';
...
// if($transmeth === 'debit')
// {
//   $subtobal = $user->Subbal($bal,$id);
//   if($subtobal)
//   {
//     $addtrans = $user->addTrans($id,$transmeth,$transtype,$transdate,$bal,$trans_status);
//     if($addtrans)
//     {
//       echo '<script> alert("ACCOUNT BALANCE HAS BEEN DEBITED SUCCESSFULLY");</script>';
//       echo '<script> window.location="dashboard.php";</script>';
//     }
//   }

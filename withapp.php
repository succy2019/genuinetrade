        ...
        <div class="row my-5">
            ...
            echo  $pr['amount'];
              ...
              <form action="" method="post">
                ...
                <button type="submit"  name="submit" id="submit-btn" class="btn btn-primary w-100">Submit</button><br><br><br>
...
$sta ='sucessful';
  ...
  $addtobal = $user->UpWith($bal,$sta,$id);
  if($addtobal)
  {
...
$sta ='reject';
    ...
    $addtrans = $user->UprejectWith($bal,$sta,$lid);
    if($addtrans)
    {
      echo '<script> alert("WITHDRAWAL TRANSACTION HAS BEEN REJECTED);</script>';
      echo '<script> window.location="dashboard.php";</script>';
    }else{
        echo '<script> alert("ERROR WHILE PERFORMING THE ACTION");</script>';
        echo '<script> window.location="dashboard.php";</script>';
